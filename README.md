This is for the solar car so that we can see the speed and location of the car, im using amazon firebase to display because its cheap and it can update the data real time. 
